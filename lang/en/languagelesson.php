...
$string['addabranchtable'] = 'Table of Contents page';
$string['addanendofbranch'] = 'End of TOC';
...
$string['addedabranchtable'] = 'Added a Table of Contents page';
$string['addedanendofbranch'] = 'Added an end of TOC';
...
$string['branch'] = 'Table of Contents';
$string['branchtable'] = 'Table of Contents';
...
$string['cannotfindtimer'] = 'Error: could not find languagelesson_timer records';
$string['cannotupdatepage'] = 'Error: could not update page record';
$string['cannotfinduser'] = 'Error: could not find users';
$string['canretake'] = '{$a} can re-take';
$string['casesensitive'] = 'Case sensitive';
$string['casesensitive_help'] = 'Check the checkbox to make the answer case sensitive';
...
$string['clozeusedropdownmenu'] = 'Use dropdown menu for this answer field';
...
$string['completionsubmit'] = 'Students must submit an answer to this lesson to complete it';
...
$string['maximumnumberofattemptsreached'] = 'Maximum number of attempts reached';
...
$string['noanswer'] = 'None or incomplete answer given.  Please go back and resubmit answers.';
...
$string['pluginname'] = 'Language Lesson';
...
//Additional strings for Language Lesson
$string['addanswerstitle'] = 'Add more answers';
$string['addanswers'] = 'Add 2 more answers';
$string['audio'] = 'Audio';
$string['makenewrecording'] = 'Make a new recording';
$string['grading'] = 'Grading';
$string['gradingtab'] = 'Grade {$a}';
...
$string['languagelesson:addinstance'] = 'Add a new language lesson';
$string['languagelesson:edit'] = 'Edit language lesson';
$string['languagelesson:manage'] = 'Manage language lesson';
$string['languagelesson:grade'] = 'Grade language lesson';
$string['languagelesson:submit'] = 'Submit language lesson';
$string['graderstudentcolumnname'] = 'Students';
$string['assigngradecolumnheader'] = 'Grade';
$string['savedgradecolumnheader'] = 'Current Grade';
$string['assigngradesbutton'] = 'Save';
$string['legendnone'] = 'Incomplete';
$string['legendstudentviewed'] = 'Student Viewed Page';
$string['legendautocorrect'] = 'Correctly Answered';
$string['legendautowrong'] = 'Incorrectly Answered';
$string['legendnew'] = 'New Submission';
$string['legendviewed'] = 'Viewed Submission';
$string['legendcommented'] = 'Commented upon submission';
$string['legendresubmit'] = 'Resubmitted';
$string['cloze'] = 'Cloze';
$string['type'] = 'Lesson Type';
$string['automaticgrading'] = 'Automatic Grading';
$string['defaultpoints'] = 'Default points per question';
$string['usepenalty'] = 'Use penalty for incorrrect answers';
$string['penaltytype'] = 'Penalty Type';
$string['penaltyvalue'] = 'Penalty value (%)';
$string['penaltymean'] = 'Mean score';
$string['penaltyset'] = 'Set penalty';
$string['practicetype'] = 'Practice';
$string['assignmenttype'] = 'Assignmnent';
$string['testtype'] = 'Test';
$string['defaultcorrectfeedback'] = 'Default correct feedback';
$string['defaultwrongfeedback'] = 'Default wrong feedback';
$string['defaultcorrectfeedbacktext'] = 'That\'s correct!';
$string['defaultwrongfeedbacktext'] = 'That\'s incorrect.  Try again!';
$string['displayleftmenuicons'] = 'Display menu icons';
$string['showoldanswer'] = 'Show previous answer';
$string['type_help'] = 'Practice, Assignment, Test';
$string['automaticgrading_help'] = 'Automatic grading awards full points to students who submit answers to any question.';
$string['defaultpoints_help'] = 'defaultpoints_help';
$string['penalty_help'] = 'penalty_help';
$string['penalty'] = 'penalty';
$string['penaltytype_help'] = 'penaltytype_help';
$string['showoldanswer_help'] = 'showoldanswer_help';
$string['defaultcorrect'] = 'defaultcorrect';
$string['defaultcorrect_help'] = 'defaultcorrect_help';
$string['defaultwrong'] = 'defaultwrong';
$string['defaultwrong_help'] = 'defaultwrong_help';
$string['displayleft'] = 'displayleft';
$string['displayleft_help'] = 'displayleft_help';
$string['contextcolors'] = 'contextcolors';
$string['contextcolors_help'] = 'contextcolors_help';
$string['gradernone'] = 'no_submission';
$string['graderstudentviewed'] = 'studentviewed';
...
$string['confirmduplicate'] = 'Confirm Duplicate';
$string['duplicatingpage'] = 'Duplicating Page... ';
$string['confirmduplicationofthispage'] = 'Confirm duplication of this page.';
$string['nobranchtable'] = 'No Table of Contents page detected.';
...
$string['branchtableid'] = 'LL_BRANCHTABLE';
$string['branchtablename'] = 'Branch Table';
$string['endofbranchid'] = 'LL_ENDOFBRANCH';
$string['endofbranchname'] = 'End of Branch';
$string['audiosubmissionstring'] = 'audiosubmissionstring';
$string['studentsubmission'] = 'studentsubmission';
$string['fbrecorderinstructions'] = 'fbrecorderinstructions';
$string['fbrecorderinstructionssimple'] = 'fbrecorderinstructionssimple';
...
$string['pagescore'] = 'Page Score';
$string['iconsrccorrect'] = '/pix/i/grade_correct.png';
$string['iconsrcwrong'] = '/pix/i/grade_incorrect.png';
$string['iconsrcaudio'] = '/mod/languagelesson/pix/speaker.jpg';
$string['iconsrcfeedback'] = '/mod/languagelesson/pix/fb_balloon.jpg';
$string['iconsrcessay'] = '/mod/languagelesson/pix/pencil.png';
$string['unlimited'] = 'Unlimited';
$string['emailssent'] = 'Emails sent to students';
$string['improperholisticgrade'] = 'Improper holistic grade';
$string['gradessaved'] = 'Grades Saved';
$string['notifycolumnheader'] = 'Send Email';