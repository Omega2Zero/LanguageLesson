...
require_once($CFG->dirroot . '/mod/languagelesson/backup/moodle2/backup_languagelesson_stepslib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_languagelesson_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_languagelesson_activity_structure_step('languagelesson_structure', 'languagelesson.xml'));
    }
